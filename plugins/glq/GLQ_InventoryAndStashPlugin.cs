...
namespace Turbo.Plugins.glq
{
    ...
    public class GLQ_InventoryAndStashPlugin : BasePlugin, IInGameTopPainter
    {
        ...
        public GLQ_InventoryAndStashPlugin()
        {
            Enabled = true;
        ...
        public override void Load(IController hud)
        {
            ...
            AncientRankFont = Hud.Render.CreateFont("tahoma", 6, 255, 255, 128, 0, false, false, true);
            AncientRankFont.SetShadowBrush(255, 0, 0, 0, true);
            PrimalRankFont = Hud.Render.CreateFont("tahoma", 6, 255, 255, 64, 64, false, false, true);
            PrimalRankFont.SetShadowBrush(255, 0, 0, 0, true);

            SocketedLegendaryGemRankFont = Hud.Render.CreateFont("tahoma", 7, 220, 255, 215, 158, true, false, false);
            SocketedLegendaryGemRankFont.SetShadowBrush(220, 0, 0, 0, true);
        ...
        private void DrawItemAncientRank(IItem item, System.Drawing.RectangleF rect)
        {
            ...
            if (ancientRank >= 1)
            {
                ...
                var ancientRankText = ancientRank == 1 ? "远古" : "太古";
