...
{
    public class GLQ_BattleTagAboveBanner : BasePlugin, IInGameWorldPainter
    {
        ...
        public GLQ_BattleTagAboveBanner()
        {
            Enabled = true;
        ...
        public void PaintWorld(WorldLayer layer)
        {
            ...
            var bannerAround = Hud.Game.Actors.Any(x => x.SnoActor.Sno == ActorSnoEnum._invisboxcollision_flippy && x.DisplayOnOverlay && x.IsOnScreen);
            ...
            foreach (var player in Hud.Game.Players)
            {
                ...
                //if (player.SnoActor == null & HeroTexture != Hud.Texture.GetTexture(890155253)) continue;
                if (player.SnoActor?.Sno == player.HeroClassDefinition.FemaleActorSno)
                {
                ...
                HeroTexture.Draw((float)(ToScreenPos.X - (ScreenWidth / 28.769)), (float)(ToScreenPos.Y - (ScreenHeight / 52.941)), (float)(ScreenHeight / 31), (float)(ScreenHeight / 31), 0.7843f);
