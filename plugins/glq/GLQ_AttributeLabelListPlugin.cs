...
namespace Turbo.Plugins.glq
{
    ...
    public class GLQ_AttributeLabelListPlugin : GLQ_BasePluginCN, IInGameTopPainter
    {

        public HorizontalTopLabelList LabelList { get; private set; }

        public GLQ_AttributeLabelListPlugin()
            : base()
        {
            Enabled = true;
        }
                ...
                ExpandUpLabels = new List<TopLabelDecorator>()
                {
                   ...
                   new TopLabelDecorator(Hud)
                    ...
                    new TopLabelDecorator(Hud)
                    {
                        ...
                        BackgroundTexture2 = Hud.Texture.BackgroundTextureGreen,
                        BackgroundTextureOpacity2 = 1.0f,
                        TextFunc = () => Hud.Game.Me.Defense.LifeOnHit.ToString(),
                        HintFunc = () => "击中恢复",
                    },
                    new TopLabelDecorator(Hud)
                    {
                        ...
                        BackgroundTexture2 = Hud.Texture.BackgroundTextureGreen,
                        BackgroundTextureOpacity2 = 1.0f,
                        TextFunc = () => Hud.Game.Me.Defense.LifeOnKill.ToString(),
                        HintFunc = () => "击杀恢复",
                    },
                    new TopLabelDecorator(Hud)
                    {
                        ...
                        BackgroundTexture2 = Hud.Texture.BackgroundTextureGreen,
                        BackgroundTextureOpacity2 = 1.0f,
                        TextFunc = () => Hud.Game.Me.Defense.LifeRegen.ToString("F0", CultureInfo.InvariantCulture),
                        HintFunc = () => "每秒恢复",
                    },
                    new TopLabelDecorator(Hud)
                    {
                        ...
                        BackgroundTexture2 = Hud.Texture.BackgroundTextureGreen,
                        BackgroundTextureOpacity2 = 1.0f,
                        TextFunc = () => (Hud.Game.Me.Defense.GlobeBonusHealth).ToString("F0", CultureInfo.InvariantCulture),
                        HintFunc = () => "生命球加成",
                    }
                }
            });
            ...
            LabelList.LabelDecorators.Add(new TopLabelDecorator(Hud)
            {
                ...
                ExpandUpLabels = new List<TopLabelDecorator>()
                {
                    ...
                    new TopLabelDecorator(Hud)
                    {
                        ...
                        BackgroundTexture2 = Hud.Texture.BackgroundTextureYellow,
                        BackgroundTextureOpacity2 = 0.75f,
                        TextFunc = () => (Hud.Game.Me.Defense.Thorns).ToString("F0", CultureInfo.InvariantCulture),
                        HintFunc = () => "荆棘伤害",
                    }
                }
            });
