...
{
    public class OtherPlayersPlusPlugin : BasePlugin, IInGameWorldPainter
	{
        ...
        public void PaintWorld(WorldLayer layer)
        {
            ...
            foreach (var player in players)
            {
                ...
                if (player.HeroClassDefinition.HeroClass.ToString() == "Barbarian")
                {
                    ...
                    if (player.HeroIsMale) HeroTexture = Hud.Texture.GetTexture(3921484788); // male/female can't be determined, let's keep it for later...
